...
namespace Web.Services.Auth
{
    public class UserService
    {
        ...
        public async Task<User?> FindUserAsync(string emailAddress, string password)
        {
            return await _db.Users.FirstOrDefaultAsync(x => x.EmailAddress == emailAddress && x.Password == password);
        }
